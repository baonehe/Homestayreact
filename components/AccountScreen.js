...
function Account({navigation}) {
  const NotificationSettingHandle = async () => {
  ...
  return (
    <ScrollView>
      ...
      <View>
        ...
        <View style={styles.Card}>
          <Icon name="cards-heart-outline" size={24} marginHorizontal={10} />
      ...
      <View>
        ...
        <View style={styles.Card}>
          ...
          <Text style={styles.FontCard} onPress={NotificationSettingHandle}>
            {' '}
            Notification
          </Text>
        </View>
        <View style={styles.Card}>
          <Icon name="earth" size={24} marginHorizontal={10} />
          <View
            style={{
              flexDirection: 'row',
      ...
      <View style={styles.Card}>
        ...
        <View
          ...
          <Text style={{...styles.FontCard, color: 'black', fontWeight: '500'}}>
            {' '}
            Ho Chi Minh
          </Text>
        </View>
      ...
      <View>
        ...
        <View style={styles.Card}>
          ...
          <View
            ...
            <Text
              style={{...styles.FontCard, color: '#9a9a9a', fontWeight: '500'}}>
              {' '}
              0.1.1
            </Text>
          </View>
