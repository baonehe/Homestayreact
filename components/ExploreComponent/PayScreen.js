...
import { Text, View, StyleSheet, TouchableOpacity, TextInput, SafeAreaView, Alert, Image, ImageBackground } from 'react-native';
    ...
    const loadHomestay = useCallback(async () => {
        try {
            ...
            if (snapshot.exists()) {
                ...
                const filteredHomestays = homestays.filter(home => home.homestay_id === data.homestay_id);
    ...
    return (
        <SafeAreaView style={styles.containers}>
            <ScrollView>
                            ...
                            <TouchableOpacity key={'hs_info'}>
                                <View style={styles.itemCard}>
                                    <View style={styles.itemImageContainer}>
                                        <Image style={styles.itemImage} source={{ uri: homestay.image }} />
                                    </View>
                                    <View style={styles.itemInfor}>
                                        ...
                                        <Text style={{ ...styles.itemType, fontFamily: "Lato-Bold" }}>{data.room_type} - No.{data.room_number}</Text>
                                        <Text
                                            numberOfLines={2}
                                            ellipsizeMode="tail" style={styles.itemType}>{homestay.location}</Text>
                                    </View>
                                </View>
                            </TouchableOpacity>
                                ...
                                <View style={styles.itemCard}>
                                    <View style={styles.itemImageContainer}>
                                        {(data.time_type === 'Hourly') ?
                                            <ImageBackground style={styles.itemImage} source={{ uri: "https://firebasestorage.googleapis.com/v0/b/homestay-cacf0.appspot.com/o/Hourly.png?alt=media&token=3d8db9a1-2f3e-41ef-9645-24de97dbbe06" }} >
                                                <Text style={styles.durationText}>{selector.hourly.duration} hour(s)</Text>
                                            </ImageBackground>
                                            : (data.time_type === 'Overnight') ?
                                                <ImageBackground style={styles.itemImage} source={{ uri: "https://firebasestorage.googleapis.com/v0/b/homestay-cacf0.appspot.com/o/Overnight.png?alt=media&token=4afc5d56-be7d-4a77-a7f1-2b7f56ec832e" }} >
                                                    <Text style={styles.durationText}>{selector.overnight.duration} night(s)</Text>
                                                </ImageBackground>
                                                : <ImageBackground style={styles.itemImage} source={{ uri: "https://firebasestorage.googleapis.com/v0/b/homestay-cacf0.appspot.com/o/Daily.png?alt=media&token=405265a0-6d56-493e-a901-9b613e22d823" }} >
                                                    <Text style={styles.durationText}>{selector.daily.duration} day(s)</Text>
                                                </ImageBackground>
                                        }
                                    </View>
                                    <View style={styles.itemInfor}>
                ...
                <View style={styles.view}>
                    ...
                    <View style={styles.view1}>
                        ...
                        <Text style={{ fontSize: 18, marginRight: 50, fontFamily: 'Inter-SemiBold', color: colors.black }}>{name}</Text>
                    </View>
                    <View style={styles.view1}>
                        <Text style={styles.content}>Phone</Text>
                        <Text style={{ fontSize: 18, marginRight: 50, fontFamily: 'Inter-SemiBold', color: colors.black }}>{phone}</Text>
                    </View>
                </View>
                <View style={styles.view}>
                    ...
                    <View style={styles.view1}>
                        ...
                        <TextInput
                            style={{ marginRight: 50, fontSize: 20, fontFamily: 'Lato-BoldItalic', color: colors.primary }}
                            value={inputValue}
                    ...
                    <View>
                        <View style={styles.view2}>
                            <Icon
                                ...
                                marginRight={10}
                            />
                            <Text style={{ fontSize: 15, color: colors.lightblack }}>Room rate</Text>
                    ...
                    <View>
                        <View style={styles.view2}>
                            <MaterialCommunityIcons
                                ...
                                marginRight={9}
                            />
                            <Text style={{ fontSize: 16, marginTop: 5, color: colors.lightblack }}>Discount</Text>
            ...
            <View style={{ backgroundColor: colors.white }}>
                <TouchableOpacity style={styles.bookbtn} onPress={() => showBookAlert()}>
